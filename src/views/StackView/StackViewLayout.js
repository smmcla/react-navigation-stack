...
import { Animated, StyleSheet, PanResponder, Platform, View, I18nManager, Easing, Dimensions, ImageBackground } from 'react-native';
...
class StackViewLayout extends React.Component {
  ...
  _renderCard = scene => {
    ...
    return (
      <Card {...this.props.transitionProps} key={`card_${scene.key}`} style={[style, { marginTop }, this.props.cardStyle]} scene={scene}>
